    ...
    <div class="min-h-screen flex flex-col lg:flex-row">
        ...
        <div class="w-full lg:w-1/2 bg-ec-blue flex items-center justify-center relative overflow-hidden py-12 lg:py-0">
            ...
            <div class="relative z-10 text-center px-6 lg:px-12">
                ...
                <div class="mt-6 lg:mt-8 text-left inline-block space-y-2 lg:space-y-3 bg-white/10 backdrop-blur-md p-4 lg:p-6 rounded-2xl border border-white/10">
        ...
        <div class="w-full lg:w-1/2 min-h-screen flex items-center justify-center p-6 lg:p-8 bg-white">
            <div class="w-full max-w-lg py-6 lg:py-8">
                ...
                <form class="space-y-5" action="<?= BASEURL; ?>/auth/processRegister" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Major (Jurusan)</label>
