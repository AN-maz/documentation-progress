...
class Agenda extends Controller
{
    ...
    public function index()
    {
        ...
        $this->view('dashboard_/admin/edu/agenda/index', $data);
    ...
    public function detail($id)
    {
        ...
        if (!$agenda) {
            ...
            header('Location: ' . BASEURL . '/edu/agenda');
            exit;
        }
        ...
        $this->view('templates/adminLayout/edu/sidebar', $data);
        $this->view('templates/adminLayout/edu/mobileNav', $data);
        $this->view('dashboard_/admin/edu/agenda/detail', $data);
        $this->view('templates/FooterDash');
    }
    ...
    public function toggle_status($id, $currentStatus)
    {
        ...
        header('Location: ' . BASEURL . '/edu/agenda/detail/' . $id);
        exit;
    }
