...
class Structure extends Controller
{
    ...
    public function index()
    {
        ...
        $this->view('dashboard_/admin/sdm/structure/index', $data);
    ...
    public function detail($id)
    {
        ...
        if (!$divisi) {
            ...
            header('Location: ' . BASEURL . '/sdm/structure');
            exit;
        }
        ...
        $this->view('templates/adminLayout/sdm/sidebar', $data);
        $this->view('templates/adminLayout/sdm/mobileNav', $data);
        $this->view('dashboard_/admin/sdm/structure/detail', $data);
        $this->view('templates/FooterDash');
    }
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            if (isset($_FILES['foto_grup']) && $_FILES['foto_grup']['error'] === UPLOAD_ERR_OK) {
                ...
                if ($uploadResult['success']) {
                    ...
                    header('Location: ' . BASEURL . '/sdm/structure/detail/' . $id_divisi);
                    exit;
                }
            }
    ...
    public function add_member()
    {
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            if (empty($_POST['id_user'])) {
                ...
                header('Location: ' . BASEURL . '/sdm/structure/detail/' . $_POST['id_divisi']);
                exit;
            }
            ...
            header('Location: ' . BASEURL . '/sdm/structure/detail/' . $data['id_divisi']);
            exit;
        }
    }
