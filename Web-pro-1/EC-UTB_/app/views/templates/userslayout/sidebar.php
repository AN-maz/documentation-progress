<aside class="hidden md:flex flex-col 
    ...
    <div class="flex items-center justify-center lg:justify-start gap-3 px-2 lg:px-4 py-6 mb-4 border-b border-white/10">
    ...
    <nav class="flex-1 px-2 lg:px-4 space-y-2">
        ...
        <a href="<?= BASEURL; ?>/DashboardUsers/agenda"
            ...
            <span class="font-medium tracking-wide hidden lg:block whitespace-nowrap">Agenda Kegiatan</span>
        </a>
        ...
        <?php if ($data['user']['status_keanggotaan'] == 'pengurus'): ?>
            <a href="<?= BASEURL; ?>/DashboardUsers/rapat"
                ...
                <span class="font-medium tracking-wide hidden lg:block whitespace-nowrap">Rapat Internal</span>
            </a>
        <?php endif; ?>
