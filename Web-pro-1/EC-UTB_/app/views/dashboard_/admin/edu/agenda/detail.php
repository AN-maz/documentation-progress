<main class="flex-1 p-4 sm:p-6 lg:p-8 md:pl-32 lg:pl-80 transition-all min-h-screen w-full">
    ...
    <div class="flex items-center gap-4 mb-6">
        <a href="<?= BASEURL; ?>/edu/Agenda" class="p-2 bg-white rounded-lg shadow-sm hover:bg-gray-50 text-gray-600">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-1 space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-md p-6 space-y-3">
                ...
                <a href="<?= BASEURL; ?>/edu/Agenda/toggle_status/<?= $data['agenda']['id_agenda']; ?>/<?= $data['agenda']['status']; ?>"
                ...
                <a href="<?= BASEURL; ?>/edu/Agenda/delete/<?= $data['agenda']['id_agenda']; ?>"
