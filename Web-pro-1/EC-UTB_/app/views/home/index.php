<section class="relative w-full min-h-screen bg-ec-blue overflow-hidden flex items-center">
  ...
  <div id="hero-bg" class="absolute inset-0 opacity-10 pointer-events-none z-0">
  ...
  <div class="absolute lg:absolute lg:right-0 lg:top-0 z-10 lg:z-20
              ...
              lg:w-1/2 lg:h-full
              pointer-events-none reveal-up" style="transition-delay: 300ms;">
  ...
  <div id="hero-content" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 h-full w-full relative z-30 flex items-center lg:items-center pt-24 sm:pt-28 lg:pt-0">
    ...
    <div class="w-full lg:w-1/2 h-full flex items-center justify-center lg:justify-start">
      ...
      <div class="text-center lg:text-left space-y-4 sm:space-y-6 py-8 sm:py-10 lg:py-20">
        ...
        <div class="reveal-up inline-block px-3 sm:px-4 py-1 sm:py-1.5 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full text-xs sm:text-sm font-medium text-white mx-auto lg:mx-0">
          WELCOME TO EC-UTB
        </div>

        <h1 class="reveal-up text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight text-white leading-tight" style="transition-delay: 100ms;">
          LEARN TOGETHER <br>
          GROW TO BE
          <span class="text-ec-red">BETTER</span>
        </h1>

        <p class="reveal-up text-gray-300 text-sm sm:text-base lg:text-lg leading-relaxed max-w-lg mx-auto lg:mx-0" style="transition-delay: 200ms;">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Atque eaque ipsum distinctio aut cum dicta vitae esse nemo.
        </p>

        <div class="reveal-up flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start pt-6 sm:pt-8" style="transition-delay: 300ms;">
          ...
          <a href="#news" class="px-6 sm:px-8 py-2.5 sm:py-3 bg-transparent text-white text-sm sm:text-base font-semibold border-2 border-white rounded-lg hover:bg-white hover:text-ec-blue transition-all duration-300">
            Learn More
          </a>
        </div>
      </div>
...
<section id="news" class="py-12 sm:py-16 lg:py-20 bg-gray-50">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
    ...
    <div class="text-center mb-12 sm:mb-16 space-y-3 sm:space-y-4 reveal-up">
    ...
    <?php if (empty($data['news'])) : ?>
      ...
      <div class="text-center py-8 sm:py-10 reveal-up">
    ...
    <?php else : ?>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
        ...
        <?php foreach ($data['news'] as $post) : ?>
          ...
          <article class="reveal-up bg-white rounded-2xl shadow-lg overflow-hidden group hover:-translate-y-2 transition-all duration-300 border border-gray-100" 
            ...
            <div class="p-6">
              ...
              <a href="<?= BASEURL; ?>/home/newsDetail/<?= $post['slug']; ?>" class="inline-flex items-center text-ec-red font-semibold hover:tracking-wide transition-all duration-300">
                Read More
    ...
    <div class="text-center mt-8 reveal-up" style="transition-delay: 200ms;">
      <a href="<?= BASEURL; ?>/home/news" class="inline-block px-6 py-3 border border-ec-blue text-ec-blue font-semibold rounded-lg hover:bg-ec-blue hover:text-white transition-colors">
        Lihat Semua Berita →
      </a>
    </div>
...
<section id="visi-misi" class="py-20 bg-white overflow-hidden relative">
  ...
  <div class="max-w-7xl mx-auto px-6 md:px-12">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
      ...
      <div class="relative order-last lg:order-first group reveal-up">
      ...
      <div class="order-first lg:order-last">
        ...
        <div class="mb-8 reveal-up" style="transition-delay: 100ms;">
        ...
        <div class="space-y-8">
          ...
          <div class="relative pl-8 border-l-4 border-ec-blue reveal-up" style="transition-delay: 200ms;">
          ...
          <div class="relative">
            <h3 class="text-xl font-bold text-ec-blue mb-4 flex items-center reveal-up" style="transition-delay: 300ms;">
              <span class="w-8 h-1 bg-ec-red mr-3 rounded-full"></span>
              Our Mission
            </h3>

            <ul class="space-y-4">
              <li class="flex items-start group reveal-up" style="transition-delay: 400ms;">
              ...
              <li class="flex items-start group reveal-up" style="transition-delay: 500ms;">
                <div class="flex-shrink-0 w-8 h-8 rounded-full bg-blue-50 flex items-center justify-center mt-1 mr-4 group-hover:bg-ec-blue transition-colors duration-300">
              ...
              <li class="flex items-start group reveal-up" style="transition-delay: 600ms;">
                <div class="flex-shrink-0 w-8 h-8 rounded-full bg-blue-50 flex items-center justify-center mt-1 mr-4 group-hover:bg-ec-blue transition-colors duration-300">
