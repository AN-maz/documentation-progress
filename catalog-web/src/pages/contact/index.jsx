            ...
            <div className="grid md:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-6">
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-gray-600 mt-1">Jl. Contoh Alamat No. 123<br />Kecamatan Dummy, Kota Testing<br />Provinsi KodePos 12345</p>
                            </div>
                        </div>
                ...
                <div className="bg-gray-100 rounded-2xl overflow-hidden border border-gray-200 min-h-[300px] relative">
                    <div className="absolute inset-0 flex flex-col items-center justify-center text-gray-400 p-6 text-center">
                        ...
                        <p>Peta lokasi Google Maps dapat diintegrasikan di sini.</p>
                    </div>
                </div>
            </div>
        </div>
